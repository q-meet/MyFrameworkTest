...
[![GoDoc](https://godoc.org/github.com/go-playground/validator?status.svg)](https://pkg.go.dev/frames/validator)
...
Please see https://pkg.go.dev/frames/validator for detailed usage docs.
